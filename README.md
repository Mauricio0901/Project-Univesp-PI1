...
----------------------------------------------------------------------------------------------------------
Mauricio Santos dos Anjos: https://github.com/Mauricio0901

Daniela Batalha da Silva: https://github.com/DanielaBatalha
...
--------------------------------------------------------------------------------------------------
Clone este repositório: https://github.com/DanielaBatalha/Projeto-Pet-Plann.git
Navegue até o diretório do web: cd frontend
Navegue até o diretório da API: cd backend
Instale as dependências front-end: npm i
Configure as variáveis de ambiente no arquivo .env:
Inicie o servidor do back-end: php -S localhost:84
Inicie o servidor do front-end: npm run serve
Acesse o sistema no seu navegador: http://localhost:8080
